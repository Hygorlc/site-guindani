...
// Volta para a pagina inicial do site (e sai do painel).
...
return (
<div style={{ minHeight: "100vh", background: "#f7f5f2", padding: "32px" }}><div style={{ marginBottom: "20px", display: "flex", gap: "8px", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" }}><div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}><button onClick={function () { setTab("leads"); }} style={{ padding: "8px 16px", background: tab === "leads" ? "#1A1A1A" : "#fff", color: tab === "leads" ? "#fff" : "#1A1A1A", border: "1px solid #1A1A1A", borderRadius: "2px", cursor: "pointer" }}>Cadastros</button><button onClick={function () { setTab("produtos"); }} style={{ padding: "8px 16px", background: tab === "produtos" ? "#1A1A1A" : "#fff", color: tab === "produtos" ? "#fff" : "#1A1A1A", border: "1px solid #1A1A1A", borderRadius: "2px", cursor: "pointer" }}>Produtos</button><button onClick={function () { setTab("carrossel"); }} style={{ padding: "8px 16px", background: tab === "carrossel" ? "#1A1A1A" : "#fff", color: tab === "carrossel" ? "#fff" : "#1A1A1A", border: "1px solid #1A1A1A", borderRadius: "2px", cursor: "pointer" }}>Carrossel</button></div><button onClick={handleLogout} title="Sair e voltar ao site" style={{ padding: "8px 16px", background: "#fff", color: "#8a1c1c", border: "1px solid #8a1c1c", borderRadius: "2px", cursor: "pointer", whiteSpace: "nowrap" }}>Sair</button></div>{tab === "leads" && (<>
